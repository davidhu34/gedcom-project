...
class UniquenamefirstnamesandbirthdatevalidationsTest(GedcomTestCase):
    ...
    def test_birth_before_marriage(self) -> None:
        ...
        self.assert_file_validation_fails(
            'incorrect_birth_before_marriage', birth_before_marriage)

        self.assert_file_validation_passes(
            'correct_birth_before_marriage', birth_before_marriage)

    def test_birth_before_death(self) -> None:
        """ test birth before death """

        self.assert_file_validation_fails(
            'incorrect_birth_before_death', birth_before_death)

        self.assert_file_validation_passes(
            'correct_birth_before_death', birth_before_death)
